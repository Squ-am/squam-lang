...
pub fn register(vm: &mut VM) {
    ...
    vm.define_native("str_concat", 2, |args| match (&args[0], &args[1]) {
    ...
    vm.define_native("str_contains", 2, |args| match (&args[0], &args[1]) {
    ...
    vm.define_native("str_starts_with", 2, |args| match (&args[0], &args[1]) {
    ...
    vm.define_native("str_ends_with", 2, |args| match (&args[0], &args[1]) {
    ...
    vm.define_native("str_to_upper", 1, |args| match &args[0] {
        ...
        other => Err(format!(
            "str_to_upper: expected string, got {}",
            other.type_name()
        )),
    });
    ...
    vm.define_native("str_to_lower", 1, |args| match &args[0] {
        ...
        other => Err(format!(
            "str_to_lower: expected string, got {}",
            other.type_name()
        )),
    });
    ...
    vm.define_native("str_split", 2, |args| match (&args[0], &args[1]) {
    ...
    vm.define_native("str_join", 2, |args| match (&args[0], &args[1]) {
    ...
    vm.define_native("parse_float", 1, |args| match &args[0] {
        ...
        other => Err(format!(
            "parse_float: expected string, got {}",
            other.type_name()
        )),
    });
    ...
    vm.define_native("float_to_str", 1, |args| match &args[0] {
        ...
        other => Err(format!(
            "float_to_str: expected float, got {}",
            other.type_name()
        )),
    });
    ...
    vm.define_native("is_digit", 1, |args| match &args[0] {
        ...
        other => Err(format!(
            "is_digit: expected int (char code), got {}",
            other.type_name()
        )),
    });
    ...
    vm.define_native("is_alpha", 1, |args| match &args[0] {
        ...
        other => Err(format!(
            "is_alpha: expected int (char code), got {}",
            other.type_name()
        )),
    });
    ...
    vm.define_native("is_alphanumeric", 1, |args| match &args[0] {
        ...
        other => Err(format!(
            "is_alphanumeric: expected int (char code), got {}",
            other.type_name()
        )),
    });
    ...
    vm.define_native("is_whitespace", 1, |args| match &args[0] {
        ...
        other => Err(format!(
            "is_whitespace: expected int (char code), got {}",
            other.type_name()
        )),
    });
    ...
    vm.define_native("to_upper_char", 1, |args| match &args[0] {
        ...
        other => Err(format!(
            "to_upper_char: expected int (char code), got {}",
            other.type_name()
        )),
    });
    ...
    vm.define_native("to_lower_char", 1, |args| match &args[0] {
        ...
        other => Err(format!(
            "to_lower_char: expected int (char code), got {}",
            other.type_name()
        )),
    });
}
